...
WASHERCOURSES = {
    ...
    'UNDERWEAR': wideq.STATE_WASHER_COURSE_UNDERWEAR,
    'WOOL': wideq.STATE_WASHER_COURSE_WOOL,
    'BOILING': wideq.STATE_WASHER_COURSE_BOILING,
    'BABYCARE': wideq.STATE_WASHER_COURSE_BABYCARE,
    'RINSE_SPIN': wideq.STATE_WASHER_COURSE_RINSE_SPIN,
    'TUBCLEAN': wideq.STATE_WASHER_COURSE_TUBCLEAN,
}
